...
$csv = $conn->query("SELECT LM.LMkey, LM.Bezeichnung, OK.OKatName, SUM(BB.BewegMenge) AS menge, HK.HerkunftName, ANY_VALUE(LI.LieferDatum) AS LieferDatum, ANY_VALUE(BB.BewegDatum) AS Fairteildatum
