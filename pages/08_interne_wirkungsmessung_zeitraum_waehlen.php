            ...
            <div class="picker-column-1">
                ...
                <div style="display: flex;">
                    <div>
                        ...
                        <input class="font-fira date-picker-field" type="text" id="input1"
                            value="<?php echo $date1formatted; ?>" onchange="startChanged(this.value)">
                    </div>
                    <div>
                        <label for="input2" class="font-fira date-picker-label">Ende</label>
                        <input class="font-fira date-picker-field" type="text" id="input2"
                            value="<?php echo $date2formatted; ?>" onchange="endChanged(this.value)">
                    </div>
                </div>
                <!-- DatePicker -->
                <div>
