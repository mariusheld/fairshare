            ...
            <div class="category-list">
                <table class="balkendiagram-content" >
                    <tr <?php echo $B1hidden; ?> >
                        <!-- Category name --> 
                        <td class="font-fira category-name"><?php echo $Kategorien1Name; ?></td>
                        <!-- Bar and info --> 
                        <td class="bar">
                            <div class="bar-container">
                                <div class="category-bar" id="bar1" data-percentage="<?php echo $Kategorien1Prozent; ?>"></div>
                                <div class="font-fira percentage"><?php echo $Kategorien1Prozent_display; ?>% (<?php echo $Kategorien1kg_display; ?> Kg)</div>
                            </div>
                        </td>
                    </tr>
                    <tr <?php echo $B2hidden; ?>>
                        <!-- Category name -->
                        <td class="font-fira category-name"><?php echo $Kategorien2Name; ?></td>
                        <!-- Bar and info --> 
                        <td class="bar">
                            <div class="bar-container">
                                <div class="category-bar" id="bar2" data-percentage="<?php echo $Kategorien2Prozent; ?>"></div>
                                <div class="font-fira percentage"><?php echo $Kategorien2Prozent_display; ?>% (<?php echo $Kategorien2kg_display; ?> Kg)</div>
                            </div>
                        </td>
                    </tr>
                    <tr <?php echo $B3hidden; ?>>
                        <!-- Category name -->
                        <td class="font-fira category-name"><?php echo $Kategorien3Name; ?></td>
                        <!-- Bar and info --> 
                        <td class="bar">
                            <div class="bar-container">
                                <div class="category-bar" id="bar3" data-percentage="<?php echo $Kategorien3Prozent; ?>"></div>
                                <div class="font-fira percentage"><?php echo $Kategorien3Prozent_display; ?>% (<?php echo $Kategorien3kg_display; ?> Kg)</div>
                            </div>
                        </td>
                    </tr>
                    <tr <?php echo $B4hidden; ?>>
                        <!-- Category name -->
                        <td class="font-fira category-name"><?php echo $Kategorien4Name; ?></td>
                        <!-- Bar and info --> 
                        <td class="bar">
                            <div class="bar-container">
                                <div class="category-bar" data-percentage="<?php echo $Kategorien4Prozent; ?>"></div>
                                <div class="font-fira percentage"><?php echo $Kategorien4Prozent_display; ?>% (<?php echo $Kategorien4kg_display; ?> Kg)</div>
                            </div>
                        </td>
                    </tr>
                    <tr <?php echo $B5hidden; ?>>
                        <!-- Category name -->
                        <td class="font-fira category-name"><?php echo $Kategorien5Name; ?></td>
                        <!-- Bar and info --> 
                        <td class="bar">
                            <div class="bar-container">
                                <div class="category-bar" data-percentage="<?php echo $Kategorien5Prozent; ?>"></div>
                                <div class="font-fira percentage"><?php echo $Kategorien5Prozent_display; ?>% (<?php echo $Kategorien5kg_display; ?> Kg)</div>
                            </div>
                        </td>
                    </tr>
                    <tr <?php echo $B6hidden; ?>>
                        <!-- Category name -->
                        <td class="font-fira category-name"><?php echo $Kategorien6Name; ?></td>
                        <!-- Bar and info --> 
                        <td class="bar">
                            <div class="bar-container">
                                <div class="category-bar" data-percentage="<?php echo $Kategorien6Prozent; ?>"></div>
                                <div class="font-fira percentage"><?php echo $Kategorien6Prozent_display; ?>% (<?php echo $Kategorien6kg_display; ?> Kg)</div>
                            </div>
                        </td>
                    </tr>
                    <tr <?php echo $B7hidden; ?>>
                        <!-- Category name -->
                        <td class="font-fira category-name"><?php echo $Kategorien7Name; ?></td>
                        <!-- Bar and info --> 
                        <td class="bar">
                            <div class="bar-container">
                                <div class="category-bar" data-percentage="<?php echo $Kategorien7Prozent; ?>"></div>
                                <div class="font-fira percentage"><?php echo $Kategorien7Prozent_display; ?>% (<?php echo $Kategorien7kg_display; ?> Kg)</div>
                            </div>
                        </td>
                    </tr>
                    <tr <?php echo $B8hidden; ?>>
                        <!-- Category name -->
                        <td class="font-fira category-name"><?php echo $Kategorien8Name; ?></td>
                        <!-- Bar and info --> 
                        <td class="bar">
                            <div class="bar-container">
                                <div class="category-bar" data-percentage="<?php echo $Kategorien8Prozent; ?>"></div>
                                <div class="font-fira percentage"><?php echo $Kategorien8Prozent_display; ?>% (<?php echo $Kategorien8kg_display; ?> Kg)</div>
                            </div>
                        </td>
                    </tr>
                    <tr <?php echo $B9hidden; ?>>
                        <!-- Category name -->
                        <td class="font-fira category-name"><?php echo $Kategorien9Name; ?></td>
                        <!-- Bar and info --> 
                        <td class="bar">
                            <div class="bar-container">
                                <div class="category-bar" data-percentage="<?php echo $Kategorien9Prozent; ?>"></div>
                                <div class="font-fira percentage"><?php echo $Kategorien9Prozent_display; ?>% (<?php echo $Kategorien9kg_display; ?> Kg)</div>
                            </div>
                        </td>
                    </tr>
                </table>
