...
<html lang=de>
            ...
            <div class="overlaychild">
                ...
                <div class="eingabe">
                    <form action="pages/admin.php" method="POST" autocomplete="off">
                        <input class="eingabefeld" name="password" id="eingabe" type="password" style="text-align: center; font-size: 20px;" <?php if($login == true){echo "style='border: 2px solid red; width: 468; height: 42px;'";}?>>
						<p class="vergessen" id="vergessen" <?php if($login == true){echo "style='color: red; display: block;'";}?>>
							Kennwort falsch
						</p>
						<div class="buttonscontainer" id="bcontainer" <?php if($login == true){echo "style='padding-top: 24px'";}?>>
	...
	<!-- Overlay-->
        <div id="startscreen-header">
            <img id="logo" src="media/logo.png" alt="fairshare" width="200px">
            <div id="startscreen-mitarbeiter-login">
                <p id="startscreen-mitarbeiter">Mitarbeiter*in</p>
                <button id="startscreen-mitarbeiter-button"><svg id="login-logo" xmlns="http://www.w3.org/2000/svg" width="28px" height="28px" fill="#99BB44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#FFFFFF" class="w-6 h-6">
	...
	<script>
        ...
        document.getElementById('startscreen-button').onclick = function() {
            window.location.href = 'pages/foodsaver_anmeldung.php';
        }
